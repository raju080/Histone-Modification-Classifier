...
def createAndTrainSiameseNetwork(processed_pair_data, parameters_dict, embedding_model_file, siamese_model_file):
    ...
    embedding_model = K_model(embedding_model.input, embedding_model.layers[-2].output)
...
def main():
    ...
    # parameter_file = 'cp_parameters.txt'
